...
export default function EditarUsuario() {
  ...
  const callEdit = async (e) => {
    e.preventDefault();
    setSubmit(true)
        await api.post(`/usuarios/editarUsuario/${state.aluno._id}`, {
          formData,
          }).then(rs => {
            alert(`Usuário ${state.aluno.nome} editado!`)
            navigate("/dashboard")
    ...
    <React.Fragment>
      ...
      <Container maxWidth="md" component="main">
        <div className={classes.heroContent}>
            ...
            <CForm className="row g-3">
              {steps[currentStep].id === 'PERSONAL' && (
                <>
                  ...
                  <CCol md={8}>
                    <CFormInput
                      value={state.aluno.nome || formData.nome}
                  ...
                  <CCol md={4}>
                    <CFormInput
                      value={state.aluno.nome || formData.dataNascimento}
                  ...
                  <CCol xs={12}>
                    <CFormInput
                      value={state.aluno.email ||  formData.email}
                  ...
                  <CCol md={6}>
                    <CFormInput
                      value={state.aluno.cpf || formatCPF(formData.cpf)}
                  ...
                  <CCol xs={2}>
                    <CFormInput
                      value={state.aluno.ddd || formData.ddd} onChange={e => handleChange(e, e.target.value)}
                  ...
                  <CCol xs={4}>
                    <CFormInput
                      value={state.aluno.celular || formData.celular}
                  ...
                  <CCol md={3}>
                    <CFormInput
                      value={state.aluno.rua || formData.rua}
                      onChange={e => handleChange(e, e.target.value)}
                  ...
                  <CCol md={3}>
                    <CFormInput
                      value={state.aluno.bairro || formData.bairro}
                      onChange={e => handleChange(e, e.target.value)}
                  ...
                  <CCol md={3}>
                    <CFormInput
                      value={state.aluno.numero || formData.numero}
                      onChange={e => handleChange(e, e.target.value)}
                  ...
                  <CCol md={3}>
                    <CFormInput
                      value={state.aluno.cidade || formData.cidade}
                      onChange={e => handleChange(e, e.target.value)}
              ...
              {steps[currentStep].id === 'CONTATO' && (
                <>
                  ...
                  <CCol md={12}>
                    <CFormInput
                      value={state.aluno.nomeCdE || formData.nomeCdE}
                      feedback="O Campo nome deve ser preenchido."
                      onChange={e => handleChange(e, validateNome(e.target.value))}
                      name="nomeCdE"
                      id="inputNomeCdE"
                  ...
                  <CCol xs={2}>
                    <CFormInput
                      value={state.aluno.dddCdE || formData.dddCdE}
                      onChange={e => handleChange(e, e.target.value)}
                      feedback="Digite um DDD válido."
                  ...
                  <CCol xs={4}>
                    <CFormInput
                      value={state.aluno.phoneCdE || formData.phoneCdE}
                      onChange={e => handleChange(e, validatePhone(e.target.value))}
                      feedback="Digite um celular válido."
                      name="celularCdE"
                      id="inputCelularCdE"
                        ...
                        <div className={classes.inputButton}>
                          <CCol md={11}>
                            <CFormInput
                              ...
                              name="doencaDescricao"
                              value={state.aluno.doencaDescricao || new Set(formData.doencaDescricao)[0]}
                              type="text"
                              id="0"
                          ...
                          <div className={classes.inputButton}>
                            ...
                            <CCol md={11} key={index}>
                              <CFormInput
                                ...
                                value={state.aluno.doencaDescricao || new Set(formData.doencaDescricao)[index + 1]}
                                type="text"
                                id={`${index + 1}`}
                        ...
                        <div className={classes.inputButton}>
                          ...
                          <CCol md={12}>
                            <CFormInput
                              ...
                              name="alergiaDescricao"
                              value={state.aluno.alergiaDescricao || new Set(formData.alergiaDescricao)[0]}
                              type="text"
                              id="0"
                              label="Qual alergia?"
                          ...
                          <div className={classes.inputButton}>
                            ...
                            <CCol md={12}>
                              <CFormInput
                                ...
                                value={state.aluno.alergiaDescricao || new Set(formData.alergiaDescricao)[index + 1]}
                                type="text"
                                id={`${index + 1}`}
                                label="Qual alergia?"
                                placeholder="Descreva a alergia"
                  ...
                  <CRow>
                    <CCol md={4}>
                      <CFormSelect
                        ...
                        required
                      >
                        <option value={state.aluno.nome || false} selected={true}>Selecione uma opção</option>
                        <option value={state.aluno.nome || true}>Sim</option>
                        <option value={state.aluno.nome || false}>Não</option>
                      </CFormSelect>
                    </CCol>
                    <CCol md={4}>
                      <CFormSelect
                        ...
                        <div className={classes.inputButton}>
                          ...
                          <CCol md={8}>
                            <CFormInput
                              ...
                              name="cirurgiaDescricao"
                              value={state.aluno.nome || new Set(formData.cirurgiaDescricao)[0]}
                              type="text"
                              id="0"
                              label="Qual cirurgia?"
                          ...
                          <CCol md={4}>
                            <CFormInput
                              ...
                              name="dataCirurgia"
                              value={state.aluno.nome || new Set(formData.dataCirurgia)[0]}
                              type="date"
                              id="0"
                          ...
                          <div className={classes.inputButton}>
                            <CCol md={8}>
                              <CFormInput
                                ...
                                value={state.aluno.nome || new Set(formData.cirurgiaDescricao)[index + 1]}
                                type="text"
                                id={`${index + 1}`}
                                label="Qual cirurgia?"
                                placeholder="Descreva a cirurgia"
                            ...
                            <CCol md={4}>
                              <CFormInput
                                ...
                                value={state.aluno.nome || new Set(formData.dataCirurgia)[index + 1]}
                                type="date"
                                id={`${index + 1}`}
                                label="Data da cirurgia"
                                required
                          ...
                          <CRow>
                            <CCol md={6}>
                              <CFormInput
                                ...
                                name="motivoInternado"
                                value={state.aluno.nome || new Set(formData.motivoInternado)[0]}
                                type="text"
                                id="0"
                            ...
                            <CCol md={3}>
                              <CFormInput
                                ...
                                value={state.aluno.nome || new Set(formData.inicioInternado)[0]}
                                type="date"
                                id="0"
                            ...
                            <CCol md={3}>
                              <CFormInput
                                ...
                                name="fimInternado"
                                value={state.aluno.nome || new Set(formData.fimInternado)[0]}
                                type="date"
                                id="0"
                                label="Data de fim"
                                required
                            ...
                            <CRow>
                              <CCol md={6}>
                                <CFormInput
                                  ...
                                  feedback="Digite o motivo da internação."
                                  name="motivoInternado"
                                  value={state.aluno.nome || new Set(formData.motivoInternado)[index + 1]}
                                  type="text"
                                  id={`${index + 1}`}
                                  label="Motivo da internação"
                                  placeholder="Descreva o motivo"
                              ...
                              <CCol md={3}>
                                <CFormInput
                                  ...
                                  feedback="Digite a data de início da internação."
                                  name="inicioInternado"
                                  value={state.aluno.nome || new Set(formData.inicioInternado)[index + 1]}
                                  type="date"
                                  id={`${index + 1}`}
                                  label="Data de início"
                                  required
                              ...
                              <CCol md={3}>
                                <CFormInput
                                  ...
                                  feedback="Digite a data de fim da internação."
                                  name="fimInternado"
                                  value={state.aluno.nome || new Set(formData.fimInternado)[index + 1]}
                                  type="date"
                                  id={`${index + 1}`}
                                  label="Data de fim"
                                  required
                        ...
                        <CRow>
                          <CCol md={6}>
                            <CFormInput
                              ...
                              name="nomeMedicamento"
                              value={state.aluno.nome || new Set(formData.nomeMedicamento)[0]}
                              type="text"
                              id="0"
                          ...
                          <CCol md={3}>
                            <CFormInput
                              ...
                              name="frequenciaMed"
                              value={state.aluno.nome || new Set(formData.frequenciaMed)[0]}
                              type="text"
                              id="0"
                              label="Frequência"
                          ...
                          <CCol md={3}>
                            <CFormInput
                              ...
                              name="dosagemMed"
                              value={state.aluno.nome || new Set(formData.dosagemMed)[0]}
                              type="text"
                              id="0"
                              label="Dosagem"
                        ...
                        <CRow>
                          <CCol md={11}>
                            <CFormInput
                              ...
                              name="obsTratamento"
                              value={state.aluno.nome || new Set(formData.obsTratamento)[0]}
                              type="text"
                              id="0"
                            ...
                            <CRow>
                              <CCol md={6}>
                                <CFormInput
                                  ...
                                  feedback="Digite o nome do medicamento."
                                  name="nomeMedicamento"
                                  value={state.aluno.nome || new Set(formData.nomeMedicamento)[index + 1]}
                                  type="text"
                                  id={`${index + 1}`}
                                  label="Nome do medicamento"
                                  placeholder="Digite o nome"
                              ...
                              <CCol md={3}>
                                <CFormInput
                                  ...
                                  feedback="Digite a frequência do medicamento."
                                  name="frequenciaMed"
                                  value={state.aluno.nome || new Set(formData.frequenciaMed)[index + 1]}
                                  type="text"
                                  id={`${index + 1}`}
                                  label="Frequência"
                                  placeholder="Ex: 2x ao dia"
                              ...
                              <CCol md={3}>
                                <CFormInput
                                  ...
                                  feedback="Digite a dosagem do medicamento."
                                  name="dosagemMed"
                                  value={state.aluno.nome || new Set(formData.dosagemMed)[index + 1]}
                                  type="text"
                                  id={`${index + 1}`}
                                  label="Dosagem"
                                  placeholder="Ex: 500mg"
                            ...
                            <CRow>
                              <CCol md={11}>
                                <CFormInput
                                  ...
                                  feedback="Digite uma observação do tratamento, se necessário."
                                  name="obsTratamento"
                                  value={state.aluno.nome || new Set(formData.obsTratamento)[index + 1]}
                                  type="text"
                                  id={`${index + 1}`}
                                  label="Observação do Tratamento"
                                  placeholder="Adicione observações extras"
         ...
         {steps[currentStep].id === 'DADOSLOGIN' && (
                <>
                  <CCol xs={12}>
                  ...
                  <CCol md={12}>
                    <CFormInput
                      value={state.aluno.idMacom || formData.idMacom}
                      feedback="O Campo id Maçom deve ser preenchido."
                      onChange={e => handleChange(e, validateNome(e.target.value))}
                      name="idMacom"
                      id="inputIdMacom"
                      label="ID Maçom:"
                ...
                <>
                  ...
                  <CCol md={4}>
                    <CFormInput
                      ...
                      name="peso"
                      value={state.aluno.nome || formData.peso || ''}
                      type="text"
                      id="peso"
                      label="Peso (kg)"
                      placeholder="Ex: 70.5"
                  ...
                  <CCol md={4}>
                    <CFormInput
                      ...
                      name="altura"
                      value={state.aluno.nome || formData.altura || ''}
                      type="text"
                      id="altura"
                      label="Altura (m)"
                      placeholder="Ex: 1.75"
                  ...
                  <CCol md={4}>
                    <CFormInput
                      ...
                      name="imc"
                      value={state.aluno.nome || formData.imc || ''}
                      type="text"
                      id="imc"
                  ...
                  <CCol md={4}>
                    <CFormInput
                      ...
                      value={state.aluno.nome || formData.pressaoArterial || ''}
                      type="text"
                      id="pressaoArterial"
                        ...
                        <CRow>
                          <CCol md={4}>
                            <CFormInput
                              ...
                              name="nomePlano"
                              value={state.aluno.nome || formData.nomePlano || ''}
                              type="text"
                              id="nomePlano"
                              label="Nome do Plano"
                          ...
                          <CCol md={4}>
                            <CFormInput
                              ...
                              name="numeroCartao"
                              value={state.aluno.nome || formData.numeroCartao || ''}
                              type="text"
                              id="numeroCartao"
                          ...
                          <CCol md={4}>
                            <CFormInput
                              ...
                              name="hospital"
                              value={state.aluno.nome || formData.hospital || ''}
                              type="text"
                              id="hospital"
                  ...
                  <CCol md={8}>
                    <CFormInput
                      ...
                      name="observacaoMed"
                      value={state.aluno.nome || formData.observacaoMed || ''}
                      type="text"
                      id="observacaoMed"
                  ...
                  <CCol md={4}>
                    <CFormInput
                      ...
                      value={state.aluno.nome || formData.ultimaRevisaoMed || ''}
                      type="date"
                      id="ultimaRevisaoMed"
              ...
              <CCol xs={12}>
                ...
                {currentStep === steps.length - 1 && (
                  <div className={classes.buttons}>
                    <CButton onClick={e => handlePreviousStep(e)} className={classes.cadastrarButton} color="secondary" type="submit">Anterior</CButton>
                    <CButton onClick={e => callEdit(e)} className={classes.cadastrarButton} color="secondary" type="submit">Cadastrar</CButton>
                  </div>
                )}
              </CCol>
            </CForm>
